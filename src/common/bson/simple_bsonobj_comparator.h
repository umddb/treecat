...
#ifndef SIMPLE_BSONOBJ_COMPARATOR_H
#define SIMPLE_BSONOBJ_COMPARATOR_H

#include <map>
#include <set>

#include "common/bson/bsonobj_comparator_interface.h"
#include "common/bson/unordered_map.h"
#include "common/bson/unordered_set.h"
