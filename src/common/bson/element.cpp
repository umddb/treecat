...
#include "common/bson/algorithm.h"
...
Status Element::appendElement(StringData fieldName, const BSONElement& value) {
    return pushBack(getDocument().makeElementWithNewFieldName(fieldName, value));
}
