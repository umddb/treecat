...
#include "common/bson/atomic_word.h"
#include "common/bson/bufreader.h"
#include "common/bson/shared_buffer.h"
...
public:
    ...
    */
    ...
    /**
     * @return second field of the object
     */
    BSONElement secondElement() const {
        return BSONElement(&objdata()[BSONElement(objdata() + 4).size() + 4]);
    }
