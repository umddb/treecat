...
#include "common/bson/visibility.h"
#include "common/bson/safe_num.h"
...
public:
    ...
    /** Append the given BSONElement with new fieldname*/
    Status appendElement(StringData fieldName, const BSONElement& value);
